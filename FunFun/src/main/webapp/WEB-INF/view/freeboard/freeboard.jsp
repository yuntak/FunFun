...
<body>
		...
		<form action="freeBoardSearch.jsp">
			...
			<div class="form-inline" align="right">
				<select name="name">
					...
					placeholder="검색"> <input type="hidden" value="1"
					name="page"> <input type="submit" value="검색"
 ...
 %>
			 ...
			 <ul class="pager"> -->
				...
				<th><a href="<%=request.getContextPath()%>/FreeBoard/Write"><img
						src="<%=request.getContextPath()%>/img/write.PNG"></a> <!-- 			</ul> 
			</th> --> <!-- <th> -->
