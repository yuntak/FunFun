...
<body>
	<sform:form method="post" onsubmit="return freeBoardWrite(this) "
		modelAttribute="Fboard">
		...
		<div class="panel-body">
			...
			<sform:textarea name="mycontent" id="content" rows="40" cols="100"
				placeholder="내용" path="fcontext" value=""></sform:textarea>
		</div>
		<br>
		...
		<div class="panel-footer">
			<div>
				...
				<a href="<%=request.getContextPath()%>/FreeBoard"
					class="btn btn-info" style="margin-bottom: 5mm;">취소</a>
